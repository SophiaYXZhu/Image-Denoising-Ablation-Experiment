...
class AugmentNoise(object):
    ...
    def add_train_noise(self, x):
        ...
        if self.style == "gauss_fix":
            ...
            noise = torch.cpu.FloatTensor(shape, device=x.device)
...
if __name__ == '__main__':
    ...
    # Masker
    masker_1 = Masker(width=2, mode='interpolate', mask_type='horizontal')
    masker_2 = Masker(width=2, mode='interpolate', mask_type='vertical')
    ...
    network_1 = network_1.cpu()
    network_2 = network_2.cpu()
    ...
    for epoch in range(epoch_init, opt.n_epoch + 1):
        ...
        for iteration, noisy in enumerate(TrainingLoader):
            ...
            pred = pred.cpu().data.clamp(0, 1).numpy()
